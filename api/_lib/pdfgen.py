# -*- coding: utf-8 -*-
"""Report Analitico PDF (fpdf2): riassume le 100 simulazioni del match
...
class Report(FPDF):
    def header(self):
        ...
        self.set_xy(10, 5)
        self.cell(0, 8, "CALCIO AI - Analytics Board | Report Monte Carlo 100 simulazioni")
        self.set_y(24)
...
def build_pdf(analysis: dict) -> bytes:
    ...
    # micro-eventi
    pdf.section("Micro-eventi attesi (medie su 100 sim)")
